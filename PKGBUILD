...
_aufs=20170206
_bfq=v8r7
_bisect=f2a0409a08502d64fbe3990354dff5902b08d2fb
...
options=('!strip')
source=("https://kernel.googlesource.com/pub/scm/linux/kernel/git/stable/linux-stable/+archive/${_bisect}.tar.gz"
...
sha256sums=('14e46285f0167ea7c4cf7c9b2e4cec483f490b359b69e1b111bbb266b77c9207'
...
prepare() {
  mkdir "${_bisect}"
  bsdtar -xvf "${_bisect}.tar.gz" -C "./${_bisect}"
  mv "${srcdir}/${_bisect}" "${srcdir}/linux-${_basekernel}"
